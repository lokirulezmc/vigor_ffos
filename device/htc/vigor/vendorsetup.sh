...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>device_htc_vigor/vendorsetup.sh at cm-10.2 · Flyhalf205/device_htc_vigor</title>
...
<meta content="9RTMWK452zN6OhkAUdW+GO7ZezK9Vv+L1n0oZaDxma8=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-8babaddc50ef8141ad5f6ad5119606bbfc694117.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="1d1621c6c706e2521663745258f92096">
        ...
        <link data-pjax-transient rel='permalink' href='/Flyhalf205/device_htc_vigor/blob/a08cdc511a9271064fd5bfea69e5f8a74a5c67e3/vendorsetup.sh'>
...
<!-- blob contrib key: blob_contributors:v21:a638653bbd8ed168944f5b21f9c5b6f4 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/Flyhalf205/device_htc_vigor/blob/cm-10.1/vendorsetup.sh"
                 data-name="cm-10.1"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/Flyhalf205/device_htc_vigor/blob/cm-10.2/vendorsetup.sh"
                 data-name="cm-10.2"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/Flyhalf205/device_htc_vigor/blob/cm-10.2-test/vendorsetup.sh"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/Flyhalf205/device_htc_vigor/blob/jellybean/vendorsetup.sh"
                 data-name="jellybean"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
      ...
      <div class="actions">
        <div class="button-group">
                <a class="minibutton tooltipped upwards"
                   ...
                   href="/Flyhalf205/device_htc_vigor/edit/cm-10.2/vendorsetup.sh"
                   data-method="post" rel="nofollow">Edit</a>
          <a href="/Flyhalf205/device_htc_vigor/raw/cm-10.2/vendorsetup.sh" class="button minibutton " id="raw-url">Raw</a>
            <a href="/Flyhalf205/device_htc_vigor/blame/cm-10.2/vendorsetup.sh" class="button minibutton ">Blame</a>
          <a href="/Flyhalf205/device_htc_vigor/commits/cm-10.2/vendorsetup.sh" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
          <a class="minibutton danger empty-icon tooltipped downwards"
             href="/Flyhalf205/device_htc_vigor/delete/cm-10.2/vendorsetup.sh"
...
<span id="L24" rel="#L24">24</span>
            ...
            <td class="blob-line-code">
                    <div class="code-body highlight"><pre><div class='line' id='LC1'><span class="c">#</span></div><div class='line' id='LC2'><span class="c"># Copyright (C) 2008 The Android Open Source Project</span></div><div class='line' id='LC3'><span class="c">#</span></div><div class='line' id='LC4'><span class="c"># Licensed under the Apache License, Version 2.0 (the &quot;License&quot;);</span></div><div class='line' id='LC5'><span class="c"># you may not use this file except in compliance with the License.</span></div><div class='line' id='LC6'><span class="c"># You may obtain a copy of the License at</span></div><div class='line' id='LC7'><span class="c">#</span></div><div class='line' id='LC8'><span class="c">#      http://www.apache.org/licenses/LICENSE-2.0</span></div><div class='line' id='LC9'><span class="c">#</span></div><div class='line' id='LC10'><span class="c"># Unless required by applicable law or agreed to in writing, software</span></div><div class='line' id='LC11'><span class="c"># distributed under the License is distributed on an &quot;AS IS&quot; BASIS,</span></div><div class='line' id='LC12'><span class="c"># WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.</span></div><div class='line' id='LC13'><span class="c"># See the License for the specific language governing permissions and</span></div><div class='line' id='LC14'><span class="c"># limitations under the License.</span></div><div class='line' id='LC15'><span class="c">#</span></div><div class='line' id='LC16'><br/></div><div class='line' id='LC17'><span class="c"># This file is executed by build/envsetup.sh, and can use anything</span></div><div class='line' id='LC18'><span class="c"># defined in envsetup.sh.</span></div><div class='line' id='LC19'><span class="c">#</span></div><div class='line' id='LC20'><span class="c"># In particular, you can add lunch options with the add_lunch_combo</span></div><div class='line' id='LC21'><span class="c"># function: add_lunch_combo generic-eng</span></div><div class='line' id='LC22'><br/></div><div class='line' id='LC23'>add_lunch_combo htc_vigor-userdebug</div><div class='line' id='LC24'>add_lunch_combo htc_vigor-eng</div></pre></div>
            </td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.05733s from github-fe125-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
